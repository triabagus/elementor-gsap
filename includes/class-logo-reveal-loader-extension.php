...
class Logo_Reveal_Loader_Extension {
	...
	public static function register_controls( $element ) {
		Logo_Reveal_Loader_Template::register_controls( $element );
	}
	...
	public static function render_loader() {
		...
		$enable_key = Logo_Reveal_Loader_Template::key( 'enable' );
		...
		wp_enqueue_script( 'elementor-logo-reveal-loader' );
		wp_enqueue_style( 'elementor-logo-reveal-loader' );

		Logo_Reveal_Loader_Template::render( $settings, $document->get_id() );
	}
