...
class Willem_Loading_Animation_Extension {
	...
	public static function register_controls( $element ) {
		Willem_Loading_Animation_Template::register_controls( $element );
	}
	...
	public static function render_loader() {
		...
		$enable_key = Willem_Loading_Animation_Template::key( 'enable' );
		...
		wp_enqueue_script( 'elementor-willem-loading' );
		wp_enqueue_style( 'elementor-willem-loading' );

		Willem_Loading_Animation_Template::render( $settings, $document->get_id() );
	}
