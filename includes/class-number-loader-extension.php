...
class Number_Loader_Extension {
	...
	public static function register_controls( $element ) {
		Number_Loader_Template::register_controls( $element );
	}
	...
	public static function render_loader() {
		...
		$enable_key = Number_Loader_Template::key( 'enable' );
		...
		wp_enqueue_script( 'elementor-number-loader' );
		wp_enqueue_style( 'elementor-number-loader' );

		Number_Loader_Template::render( $settings, $document->get_id() );
	}
